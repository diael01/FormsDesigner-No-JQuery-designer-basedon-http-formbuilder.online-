...
$(document).ready(function () {
    require(['vs/editor/editor.main'], function () {
        var MODES = (function () {
            ...
            modesIds[1] = "javascript";
            modesIds[2] = "plaintext";
...
function loadDiffSample() {
    ...
    $.ajax({
        type: 'GET',
        url: 'http://localhost:54310/Scripts/monaco-editor/index/samples/diff.lhs.txt',
        dataType: 'text',
        error: onError
    }).done(function (data) {
        lhsData = data;
    ...
    $.ajax({
        type: 'GET',
        url: 'http://localhost:54310/Scripts/monaco-editor/index/samples/diff.rhs.txt',
        dataType: 'text',
        error: onError
    }).done(function (data) {
        rhsData = data;
